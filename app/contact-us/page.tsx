    ...
    <main className="min-h-screen bg-[#ffffff] font-inter overflow-x-hidden">
      ...
      <section className="w-full bg-gray-50 py-12 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <a href={`https://wa.me/${data?.whatsappNumber || '60163966562'}`} target="_blank" rel="noopener noreferrer" className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-100 flex flex-col items-center text-center">
            <div className="bg-[#25D366]/10 w-14 h-14 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            <div className="mt-4 px-4 py-2 bg-gray-50 rounded-full text-[#1c2431] font-bold text-sm tracking-widest">
              +{data?.whatsappNumber || "60 16-396 6562"}
            </div>
          </a>

          <a href={`https://instagram.com/${data?.instagramUser || 'jiffybooth'}`} target="_blank" rel="noopener noreferrer" className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-100 flex flex-col items-center text-center">
            <div className="bg-[#e4405f]/10 w-14 h-14 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            <div className="mt-4 px-4 py-2 bg-gray-50 rounded-full text-[#1c2431] font-bold text-sm">
          ...
          <a 
            ...
            className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-100 flex flex-col items-center text-center"
          >
            <div className="bg-[#2c343f]/10 w-14 h-14 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">

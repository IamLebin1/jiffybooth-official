        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {sanityServices.map((service: any) => (
            <div key={service._id} className="group flex flex-col bg-white rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 hover:-translate-y-2 transition-all duration-500">
              ...
              <div className="relative aspect-[4/3] w-full p-4" style={{ backgroundColor: service.accentColor || '#f5ebe0' }}>
              ...
              <div className="p-8 flex flex-col flex-grow space-y-4">
                ...
                <Link 
                  ...
                  className="mt-4 block w-full py-4 bg-slate-800 text-white text-center rounded-xl font-bold uppercase tracking-widest hover:bg-black transition-all"
                >
                  Explore Service
                </Link>
              </div>
